...
const containerModel = document.getElementById('containerModel');
  ...
  renderer.setSize(window.innerWidth, window.innerHeight * 0.915);
  ...
  function onWindowResize() {
    renderer.setSize(containerModel.clientWidth, containerModel.clientHeight);
...
const aNumbTitle = document.getElementById('aNumbTitle');
 // Set initial variables
  ...
  function toggleMenu() {
    ...
    if (isMenuOpen) {
      imgToggleMenu.style.transform = 'scale(0.04) rotate(180deg)';
      ...
      imgToggleMenu.style.transform = 'scale(0.04) rotate(0deg)';
      menuLobes1.style.display = 'none';
      menuLobes2.style.display = 'none';
      menuLobes3.style.display = 'none';
      menuSection.style.display = 'none';
 ...
 // Use the showSections function
  ...
  function makeBodyResponsive() {
    ...
    function updateBodyHeight() {
      ...
      // Set the body height to match the window height
      body.style.height = `${windowHeight}px`;
    }
  
    // Call the function initially to set the body height
    updateBodyHeight();
  
    // Update the body height when the window is resized
